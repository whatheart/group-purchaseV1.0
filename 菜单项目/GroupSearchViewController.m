...
@interface GroupSearchViewController ()<UISearchBarDelegate, UISearchDisplayDelegate>
...
- (IBAction)click:(UIButton *)sender {
    ...
    {
        [self performSegueWithIdentifier:@"groupSearch" sender:button];
    }
}
...
{
    [self performSegueWithIdentifier:@"groupSearch" sender:self.keyword];
}
